...
const tools = [
  ...
  { id: 'cleanexcel', icon: Sparkles, title: 'Clean Excel', desc: 'Remove empty rows/columns, trim spaces, delete duplicates, then download cleaned file.', badge: 'Data Cleanup', color: 'from-emerald-500/30 to-lime-400/10 border-emerald-500/20 text-emerald-400' },
];
